...
- **自动战斗**：玩家自动向最近的敌人发射子弹
- **弹珠反弹**：子弹命中敌人/墙壁会反弹，飞出屏幕上方消失
- **敌人体积**：敌人之间有实体体积，不再重叠
- **多边形敌人**：敌人支持三/四/五/六边形外观，战斗更有变化
...
### 2026/2/6
- 🧭 **斜向探索与方向控制**：
  - 方向随机角度平滑转向，深度按 Y 投影累计
  - 水平世界循环（wrap），敌人/子弹/特效等坐标全量适配
- ↔️ **水平缓冲带**：
  - 横向 wrap 增加 1 屏宽缓冲，避免出屏即回屏
  - 地图铺满扩展宽度，缓冲区背景完整
- 🌊 **程序化深海背景**：
  - 低多边形深海底色，轻微光束/浮尘/波纹/慢速视差
  - 地面砖块默认不绘制（仅保留墙体可选开关）
- 🎯 **射线视觉改进**：
  - 射线特效改为屏幕空间长射线，长度稳定超屏
- ☣️ **瘟疫特效升级**：
  - 附着与死亡云雾加入多层雾团与柔边粒子，表现更高级
- ⚡ **穿透/反弹逻辑修正**：
  - 非穿透子弹命中敌人反弹，穿透子弹可穿过敌人，仅墙壁反弹
- 🌿 **水草迷雾探索**：
  - 水草区域遮挡视野，靠近才显形；子弹未揭示区域会反弹
  - 玩家离开后，已进入水草的子弹自动消失
  - 水草内敌人/宝箱隐藏，需贴近探索
- 🌫️ **海底迷雾区域**：
  - 大范围雾区+更大视距，逻辑可复用（与水草同机制）
- 🍃 **水草形态优化**：
  - 由矩形改为不规则团块
  - 去描边、统一颜色叠加，视觉更自然
- 🏊 **水中惯性**：
  - 玩家/敌人移动加入轻度缓冲与拖拽感
  - 可在 `WATER_INERTIA` 中调参
- 🧍 **主角贴图与动画**：
  - 接入 Underwater Diving Pack 主角贴图
  - Idle/Swim/Fast/Rush/Hurt 动画切换，左右移动自动转向
  - 生成黄/橙两套配色（当前默认黄色）
- 🌈 **射线颜色分离**：
  - 子弹颜色恢复原值，射线特效改用 `rayColor`
  - 辐射/虚空/高温/寒束/日光矛/地脉束/轨道束射线色可单独配置
### 2026/2/5
- ⚾ **弹珠反弹机制**：
  - 子弹命中敌人与墙壁会按入射角反弹
  - 上方出界消失，左右/下方反弹
- 🧱 **敌人体积分离**：
  - 敌人之间加入碰撞分离，避免重叠堆叠
- ⏳ **子弹寿命调整**：
  - 新增 BULLET_LIFETIME_MULTIPLIER，整体寿命提升
- 🔺 **多边形敌人外观**：
  - 敌人支持三/四/五/六边形绘制并轻微旋转
- ✅ **命中判定优化**：
  - 大体积敌人增加碰撞容错，提升命中稳定性
- 🧭 **敌人形状规则**：
  - 无攻击敌人圆形，tier 0 三角形，tier 1 四边形，高阶五/六边形
- 🧨 **敌人数量提升**：
  - 新增 `ENEMY_SPAWN_MULTIPLIER`，敌人生成数量约 3 倍
- 🎯 **武器半径调整**：
  - 辐射射线/蔓延/虚空射线/寒束/闪耀电弧/日光矛/地脉束/轨道束 半径 4
  - 避雷针半径 6，血震半径 8
### 2026/2/3
- 🌟 **进化武器「闪烁」重做**：
